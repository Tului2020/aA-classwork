...
# p substrings("cat")
dict = { "cat" => "eins", "at" => "zwei"}


def subwords(word, dictionary)
  new_arr = []
  substrings(word).each do |el|
...
# p [1, 2, 3].my_map {|el| 2 * el}
# p [1, 2, 3].my_select{ |el| el.even?}
